...
if.end.split:                                     ; preds = %if.end
  %9 = load i32* getelementptr inbounds ([100 x i32]* @a, i32 0, i64 97), align 4
  store i32 %9, i32* %ld
  %10 = add nsw i32 %4, 5
  store i32 %10, i32* %dependents
  %11 = mul nsw i32 %add9, 3
  store i32 %11, i32* %dependents1
  store i1 false, i1* %flag
...
for.inc12:                                        ; preds = %if.end.split.split
...
for.end14:                                        ; preds = %for.cond1
  ...
  %15 = load i32* getelementptr inbounds ([100 x i32]* @b, i32 0, i64 98), align 4
  %16 = load i32* getelementptr inbounds ([100 x i32]* @b, i32 0, i64 99), align 4
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %14, i32 %15, i32 %16)
  ret i32 0
}
