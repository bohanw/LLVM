...
## Get Lamp profile
opt -load /home/bohanw/583/hw2/slicm/$mode+Asserts/lib/slicm.so -lamp-insts -insert-lamp-profiling -insert-lamp-loop-profiling -insert-lamp-init < $fname.ls.bc > $fname.lamp.bc 
llc < $fname.lamp.bc > $fname.lamp.s
g++ -o $fname.lamp.exe $fname.lamp.s /home/bohanw/583/hw2/slicm/tools/lamp-profiler/lamp_hooks.o
./$fname.lamp.exe

## Run your pass
opt -basicaa -load /home/bohanw/583/hw2/slicm/$mode+Asserts/lib/slicm.so -lamp-inst-cnt -lamp-map-loop -lamp-load-profile -profile-loader -profile-info-file=llvmprof.out -slicm   < $fname.ls.bc > $fname.slicm.bc 
