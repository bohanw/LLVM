...
clang -emit-llvm -o $fname.bc -c ./src/$fname.c || { echo "Failed" ;exit 1;}
...
g++ -o $fname.lamp.exe $fname.lamp.s /home/bohanw/583/ldstats/tools/lamp-profiler/lamp_hooks.o || { echo "can't compile g++"; exit 1;}

./$fname.lamp.exe $2

echo "Done generating LAMP profile"

opt -f -load  /home/bohanw/583/ldstats/Release+Asserts/lib/mypass.so -lamp-inst-cnt -lamp-map-loop -lamp-load-profile -profile-loader  \
-profile-info-file=llvmprof.out -mypass < $fname.ls.bc > /dev/null
